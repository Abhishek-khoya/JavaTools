...
class SetterGetterGenerator
{
    ...
    try
    {
        ...
        //code to generate default constructor starts here
  ...
  //code to generate setter / getter for every fields starts here
        for(i=0;i<fields.length;i++)
        {
            field=fields[i];
            //code to generate setters starts here
    ...
    //code to set default values in default constructor ends here
    static private String getSetterName(Field field)
    {
        String name=field.getName();
        if(name.length()==1) return "set"+name.toUpperCase();
        return "set"+String.valueOf(name.charAt(0)).toUpperCase()+name.substring(1);
    }
    static private String getGetterName(Field field)
    {
        String name=field.getName();
